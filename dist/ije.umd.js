(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('mmuo'), require('bootstrap')) :
    typeof define === 'function' && define.amd ? define(['exports', 'mmuo', 'bootstrap'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ije = {}, global.mmuo, global.bootstrap));
})(this, (function (exports, mmuo, bootstrap) { 'use strict';
    ...
    function uploadImageEvent() {
      mmuo.on(".image", "change", uploadImage);
    }

    function removeImageEvent() {
      mmuo.on(".remove-image", "click", removeImage);
    }

    function openAsModalEvent() {
      mmuo.on(".open-as-modal", "click", openAsModal);
    }

    function alertBeforeRunningEvent() {
      mmuo.on(".pre-run", "click", alertBeforeRunning);
    }
